// Ikony Lucide jako inline SVG. Funkcja zwraca element <svg>.
// Tylko ikony, których naprawdę używamy.
...
const PATHS = {
  ...
  'wallet': `<path d="M19 7V4a1 1 0 0 0-1-1H5a2 2 0 0 0 0 4h15a1 1 0 0 1 1 1v4h-3a2 2 0 1 0 0 4h3a1 1 0 0 0 1-1v-2"/><path d="M3 5v14a2 2 0 0 0 2 2h15a1 1 0 0 0 1-1v-4"/>`,
  'filter': `<polygon points="22 3 2 3 10 12.46 10 19 14 21 14 12.46 22 3"/>`,
  'refresh-cw': `<path d="M3 12a9 9 0 0 1 9-9 9.75 9.75 0 0 1 6.74 2.74L21 8"/><path d="M21 3v5h-5"/><path d="M21 12a9 9 0 0 1-9 9 9.75 9.75 0 0 1-6.74-2.74L3 16"/><path d="M8 16H3v5"/>`,
};

export function icon(name, { size = 22, strokeWidth = 2, class: cls = '' } = {}) {
  ...
  svg.innerHTML = PATHS[name] || PATHS['package'];
  return svg;
}
